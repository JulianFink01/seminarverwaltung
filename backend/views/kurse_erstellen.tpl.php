			...
			<form action="index.php?aktion=kurse_erstellen#allgemeiner" method="post">
				<div id="input">
					<p class="einzug"> Titel
						<input type="text" name="titel" id="titelkurs" required />
					</p>
					<p class="einzug"> Datum
						<input type="date" name="datum" id="datumkurs" required placeholder="31-12-2020" />
					</p>
				</div>
				<p id="#">Beschreibung</p>
				...
				<input class="Senden_erstellen " type="submit" onclick="myFunction()" value="<?php
																								echo (isset($_GET['kurs_id']))
																									? 'Bearbeiten'
																									: 'Speichern';
																								?>">
				<div id="back">
					<a href="?aktion=alle_kurse&fortbildung_id=<?php
																...
																?>#allgemeiner">
						<img class="kurs_icons" id="zurueck" src="images/zurueck_icon.png" title="Zurück" />
					</a>
				</div>
