	...
	<main>
		...
		<div id="beschreibung">
			...
			<table id="infos-table">
				...
				<tr>
					<td>THEMA:</td>
					<td><?php echo $kurse->getTitel() ?></td>
				</tr>

				<tr>
					<td>TAG:</td>
					<td><?php echo str_replace('/', '.', date("d/m/Y", strtotime($kurse->getDatum()))); ?></td>
				</tr>

				<tr>
					<td>UHRZEIT:</td>
					<td>von <?php echo $kurse->getVon() ?> bis <?php echo $kurse->getBis() ?></td>
				</tr>

				<tr>
					<td>REFERENT:</td>
					<td> <?php echo $kurse->getReferent() ?></td>
				</tr>

				<tr>
					<td>RAUM:</td>
					<td><?php echo $kurse->getOrt_raum() ?></td>
				</tr>
