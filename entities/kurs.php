...
class Kurs
{
	...
	public function  __toString()
	{
		return 'Id:' . $this->id
			...
			. ', Ort-Raum: ' . $this->ort_raum
			. ', Kontakt: ' . $this->kontakt
			. ', Von: ' . $this->von
			. ', Bis:' . $this->bis
			. ', Unterschriftsliste-Zweispaltig: ' . $this->unterschriftsliste_zweispaltig
			. ', Koordination: ' . $this->koordination
			. ', Anmeldeschluss: ' . $this->anmeldeschluss
			. ', FortbildungsId: ' . $this->fortbildung_id
			. ', Dauer: ' . $this->dauer;
	}
	...
	public function getFormatedDate()
	{
		...
		if ($von != "") {
			$datum = $datum
				. ' <span class="info-not-important">von </span>' . $von
				. '<span class="info-not-important"> - </span>' . $bis . ' Uhr';
		}
		return $datum;
	}
